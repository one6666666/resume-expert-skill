...
**Resume Expert v2.0 已全面适配 AI 时代简历标准**，参考程序员鱼皮（20K+ 简历修改经验）的《AI 时代满分程序员简历》方法论：
...
本 Skill 的方法论参考了程序员鱼皮（codefather.cn）的《AI 时代，满分的程序员简历是怎么样的？》，这是一篇基于几千份简历修改经验总结的深度指南。
